...
> [!NOTE]   
> Por exemplo, a URL https://github.com/RaphaTravassos/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`RaphaTravassos`" para a contribuição no repositório `dio-lab-open-source`.
